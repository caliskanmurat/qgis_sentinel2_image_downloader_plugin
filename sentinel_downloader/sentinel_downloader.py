...
from qgis.core import QgsVectorLayer, QgsProject, QgsWkbTypes, QgsMapLayer, Qgis
...
class DownloadSentinel:
    ...
    def cleanFootprints(self):
        ...
        if oname == "btn_execute_3":
            ...
            self.dlg.btn_execute_3.setEnabled(False)
            self.dlg.processEvents()
            ...
            self.dlg.btn_execute_4.setEnabled(False)
            self.dlg.processEvents()
        ...
        if oname == "btn_execute_3":
            ...
            self.dlg.btn_execute_3.setEnabled(True)
            self.dlg.processEvents()
            
        elif oname == "btn_execute_4":
            self.dlg.btn_execute_4.setText("RUN")
            self.dlg.btn_execute_4.setEnabled(True)
            self.dlg.processEvents()
        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                try:
                    ...
                    resp = requests.get(results_url, verify=False)
                resp_json = resp.json()
                ...
                try:
                    ...
                    resp = requests.get(results_img_data_url, verify=False)
                    ...
                    for rj in resp_json["result"]:
                        if "(r10m)" in rj["Nodes"]["uri"].lower():
                            ...
                            try:
                                ...
                                resp10 = requests.get(results_nodes_url_r10, verify=False)
                            ...
                            try:
                                ...
                                resp20 = requests.get(results_nodes_url_r20, verify=False)
                            ...
                            try:
                                ...
                                resp60 = requests.get(results_nodes_url_r60, verify=False)
    ...
    def executeDownloadImages(self):
        ...
        self.dlg.btn_execute_2.setEnabled(False)
        self.dlg.processEvents()
            ...
            if self.chc_other["ql"].isChecked():
                ...
                try:                        
                    ...
                    try:
                        ...
                        response = requests.get(ql_url, verify=False)
        ...
        self.dlg.btn_execute_2.setEnabled(True)
        self.dlg.processEvents() 
            
        self.iface.messageBar().pushMessage("Created", "Images Downloaded!" , level=Qgis.Success, duration=10)
