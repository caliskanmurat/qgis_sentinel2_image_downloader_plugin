...
<b>Clip and Merge:</b> Downloaded images can be merged as VRT file based on _date, zone number and product type_. Also images can be clipped using query extent.
